...
1. 多线程版并发测试
    > java -classpath asr-client-demo-1.0.8-RELEASE.jar com.yiwise.asr.demo.MultiThreadAsrDemoBootstrap
2. 单线程版测试
    > java -classpath asr-client-demo-1.0.8-RELEASE.jar com.yiwise.asr.demo.SingleThreadAsrDemoBootstrap
